...
async function borderImage(this: JimpPlugins, border_left: number, border_top: number, border_right: number, border_bottom: number, new_width: number, new_height: number) {
