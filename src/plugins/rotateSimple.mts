...
function rotateSimple(this: JimpPlugins, deg: number): JimpPlugins {
    ...
    function rotate90degrees(bitmap: import("@jimp/core").Bitmap, dstBuffer: Buffer, clockwise: boolean): void {
